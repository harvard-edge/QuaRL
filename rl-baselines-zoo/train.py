...
if __name__ == '__main__':
    ...
    parser.add_argument('-q', '--quant-bit-width', help="Set Quantization bitwidth", type=int, default=8)
    parser.add_argument('--quant-delay', help="Set quant delay apart from 5M", default=5000000, type=int)
    ...
    for env_id in env_ids:
        ...
        if args.trained_agent.endswith('.pkl') and os.path.isfile(args.trained_agent):
            ...
            model = ALGOS[args.algo](env=env, tensorboard_log=tensorboard_log, verbose=args.verbose, w_bits=args.quant_bit_width, act_bits=args.quant_bit_width, quant_delay = args.quant_delay, quant_train = "train", **hyperparams)
