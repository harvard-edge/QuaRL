...
frozen_graph_def = os.path.join(args.base, 'frozen_qt', str(args.quant_bit_width), args.algo, args.env + ".pb")
os.makedirs("/".join(frozen_graph_def.split("/")[:-1]), exist_ok=True)
print("Freezing Graph")
subprocess.check_output(['./freeze_qt.sh', args.algo, args.env,  args.base])
